...
𝗠𝗲𝘀𝘀𝗮𝗴𝗲 : <code>{}</code>"""
    ...
    I_CUDNT = """ʜᴇʟʟᴏ {} ɪ ᴄᴀɴ ɴᴏᴛ ꜰɪɴᴅ ᴀɴʏ ᴍᴏᴠɪᴇ ᴛʜᴀᴛ ɴᴀᴍᴇ."""

    I_CUD_NT = """ʜᴇʟʟᴏ {} ɪ ᴄᴀɴ ɴᴏᴛ ꜰɪɴᴅ ᴀɴʏᴛʜɪɴɢ ʀᴇʟᴇᴛᴇᴅ ᴛᴏ ᴛʜᴀᴛ. ᴄʜᴀᴄᴋ ʏᴏᴜʀ ꜱᴘᴇʟʟɪɴɢ."""
    
    CUDNT_FND = """ʜᴇʟʟᴏ {} ɪ ᴄᴀɴ ɴᴏᴛ ꜰɪɴᴅ ᴀɴʏᴛʜɪɴɢ ʀᴇʟᴇᴛᴇᴅ ᴛᴏ ᴛʜᴀᴛ. ᴄʜᴀᴄᴋ ʏᴏᴜʀ ꜱᴘᴇʟʟɪɴɢ."""
    
    REPRT_MSG = """ʀᴇᴘᴏʀᴛᴇᴅ ᴀᴅᴍɪɴ"""
